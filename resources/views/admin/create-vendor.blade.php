...
<head>
    ...
    <title>Tambah Vendor - Admin Dashboard</title>
...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <h2 style="margin:0">Tambah Vendor Baru</h2>
        </div>
        ...
        <div class="form-container">
            ...
            <form action="{{ route('admin.kelola-vendor.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" required placeholder="Contoh: Spesialis ayam penyet dan sambal"></textarea>
                </div>
                ...
                <h3 style="margin-top: 30px; margin-bottom: 20px; color: #333;">Informasi Akun Penjual</h3>

                <div class="form-group">
                    <label for="name">Username Penjual</label>
                    <input type="text" class="form-control" id="name" name="name" required placeholder="Contoh: penjual_kantin_biru">
                </div>

                <div class="form-group">
                    <label for="email">Email Penjual</label>
                    <input type="email" class="form-control" id="email" name="email" required placeholder="Contoh: penjual@kantin.com">
                </div>
